...
public class ProductManager {
    ...
    private PreparedStatement getSeachByNameStatement() throws ClassNotFoundException, SQLException {
        if (searchByNameStatement == null) {
            Connection connection = DBConnection.getConnection();
            searchByNameStatement
                    = connection.prepareStatement("select id,[name],[price],[description] from product");

        }
        return searchByNameStatement;
    }
    
   private PreparedStatement getSearchByIdStatement() throws SQLException, ClassNotFoundException {
    ...
    public List<Product> getProductsByName(String keyword) throws ClassNotFoundException {
        try {
            PreparedStatement statement = getSeachByNameStatement();
